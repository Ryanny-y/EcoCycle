    ...
    <Card className="gap-4">
      ...
      <CardContent>
        <div className="relative h-12">
          ...
          {searchInput && fakeFoundRecords.length > 0 && (
              ...
              {fakeFoundRecords.map(r => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="font-bold text-gray-900">{r.lastName}, {r.firstName}</p>
                    <p className="text-xs text-gray-500">Balance: {r.points} pts</p>
                  </div>

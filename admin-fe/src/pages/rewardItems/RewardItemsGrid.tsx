    ...
    <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-6 gap-5">
      <Card className="pt-0 gap-2 group">
        <div className="relative h-44 rounded-t-xl overflow-hidden">
          <img
            src="https://picsum.photos/seed/rug/400/300"
        ...
        <CardContent className="px-4 space-y-2">
          <div className="flex items-center justify-between">
            <h1 className="font-bold text-xl">Eco Rug</h1>
            <p className="text-primary font-bold text-lg">20 pts</p>
          </div>
          <p className="text-muted-foreground text-sm">
            Hand-woven rug made from recycled fabrics and textiles.
          </p>
        </CardContent>
        ...
        <CardFooter className="px-4 mt-5">
          <p className="text-xs font-semibold text-muted-foreground flex items-center gap-2">
            Available Stocks:{" "}
            <span className="font-bold text-black text-base">25</span>
          </p>
        </CardFooter>
      </Card>

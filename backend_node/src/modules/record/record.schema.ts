...
export const createRecord = {
  body: z.object({
    ...
    birthDate: z.coerce
      ...
      .optional(),
    gender: z.enum([Gender.MALE, Gender.FEMALE, Gender.LGBTQIA_PLUS, Gender.PREFER_NOT_TO_SAY, Gender.OTHER]),
    isResident: z.boolean().optional().default(true),
    role: z.enum([Role.RESIDENT, Role.NON_RESIDENT, Role.STAFF]).optional().default(Role.RESIDENT),
